                                ...
                                <form action="{{ route('category.update', $category->id) }}" method="POST"
                                    ...
                                    <div class="mb-3">
                                        ...
                                        @if ($category->image)
                                            <div class="mt-2">
                                                <img id="currentImage"
                                                    src="{{ asset('image/category/' . $category->image) }}"
                                    ...
                                    <div class="form-group mb-4 col-md-12">
                                        ...
                                        <textarea id="summernote"  name="text" class="form-control @error('text') is-invalid @enderror" placeholder="Enter additional texts">{{ old('text', $category->text) }}</textarea>
                                        @error('text')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
