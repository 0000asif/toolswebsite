...
@section('front_content')
    <div class="singlePageBg course-home-section">
        @php
            $tools = App\Models\Blog::where('status', 1)->where('slug', 'ascii-to-decimal-converter')->first();
        @endphp
        ...
        <div class="container sirajganj_single_post_container">
            <div class="row mt-3">
                <div class="col-md-9">
                    <div class="postBody">
                        <h2 class="postBodyTitle">{{ $tools->title ?? 'ASCII to Decimal Converter' }}</h2>
                    </div>
                    ...
                    <div class="mainTools">
                        <div class="password_gen text-center">
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input type="text" class="form-control mt-2" id="asciiInput" placeholder="e.g. Hello">
                            </div>
...
@push('front_js')
    ...
    <script>
        ...
        document.getElementById('asciiInput').addEventListener('keyup', function() {
            const input = document.getElementById('asciiInput').value;
            if (!input) return;
